...
public class DownloadService extends Service {
	...
	private void createNotication(Intent intent) {
		...
		updateNotification = new Notification(17301633, "正在下载", when);

		updateIntent = new Intent(this, intent.getClass());
		updatePendingIntent = PendingIntent.getActivity(this, 0, updateIntent,
				0);

		updateNotification.setLatestEventInfo(this, "下载进度：", "0%",
				updatePendingIntent);
		...
		try {
			...
			do {
				...
				if ((downloadCount == 0)
					...
					downloadCount += 10;
					this.updateNotification.setLatestEventInfo(this, "下载进度",
